...
function renderBankData(bankData) { 
    ...
    Object.keys(bankMethodMap).forEach(method => {
        ...
        // Данные для установки ячеек итогов метода
        const totalCellData = [
    ...
    // Итоговые данные по процессингу
